...
(
    ...
    { 
        $current = $this_AdditionOperator_14.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_SubtractionOperator_15.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_MultiplicationOperator_16.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DivisionOperator_17.current; 
        afterParserOrEnumRuleCall();
    }
)
;
