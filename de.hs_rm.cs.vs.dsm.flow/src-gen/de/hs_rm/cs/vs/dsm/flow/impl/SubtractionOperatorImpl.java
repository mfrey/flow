 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.impl.SubtractionOperatorImpl#getLiteralList <em>Literal List</em>}</li>
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.impl.SubtractionOperatorImpl#getStreamElementList <em>Stream Element List</em>}</li>
...
public class SubtractionOperatorImpl extends ReturnTypeOperatorImpl implements SubtractionOperator
{
  ...
  public EList<BigDecimal> getLiteralList()
  {
    if (literalList == null)
    {
      literalList = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, FlowPackage.SUBTRACTION_OPERATOR__LITERAL_LIST);
    }
    return literalList;
  }
  ...
  public EList<StreamAccess> getStreamElementList()
  {
    ...
    {
      streamElementList = new EObjectContainmentEList<StreamAccess>(StreamAccess.class, this, FlowPackage.SUBTRACTION_OPERATOR__STREAM_ELEMENT_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case FlowPackage.SUBTRACTION_OPERATOR__STREAM_ELEMENT_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FlowPackage.SUBTRACTION_OPERATOR__PARAMETER:
        return getParameter();
      case FlowPackage.SUBTRACTION_OPERATOR__LITERAL_LIST:
