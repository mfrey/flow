 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.impl.DivisionOperatorImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DivisionOperatorImpl extends ReturnTypeOperatorImpl implements DivisionOperator
{
  ...
  public void setLiteral(BigDecimal newLiteral)
  {
    ...
    literal = newLiteral;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__LITERAL, oldLiteral, literal));
  }
  ...
  public NotificationChain basicSetStreamElement(StreamAccess newStreamElement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT, oldStreamElement, newStreamElement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStreamElement(StreamAccess newStreamElement)
  {
    if (newStreamElement != streamElement)
    {
      ...
      if (streamElement != null)
        msgs = ((InternalEObject)streamElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT, null, msgs);
      if (newStreamElement != null)
        msgs = ((InternalEObject)newStreamElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT, null, msgs);
      msgs = basicSetStreamElement(newStreamElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT, newStreamElement, newStreamElement));
  }
  ...
  public VariableDefinition getVariable()
  {
    if (variable != null && variable.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FlowPackage.DIVISION_OPERATOR__VARIABLE, oldVariable, variable));
      }
    }
    return variable;
  }
  ...
  public void setVariable(VariableDefinition newVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__VARIABLE, oldVariable, variable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case FlowPackage.DIVISION_OPERATOR__VARIABLE:
