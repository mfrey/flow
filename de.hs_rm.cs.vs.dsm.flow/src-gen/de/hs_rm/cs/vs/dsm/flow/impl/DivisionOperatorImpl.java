 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.impl.DivisionOperatorImpl#getLiteralList <em>Literal List</em>}</li>
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.impl.DivisionOperatorImpl#getStreamElementList <em>Stream Element List</em>}</li>
 ...
 * @generated
 */
public class DivisionOperatorImpl extends ReturnTypeOperatorImpl implements DivisionOperator
{
  /**
  ...
  {
    return FlowPackage.Literals.DIVISION_OPERATOR;
  }
  ...
  public NotificationChain basicSetParameter(StreamAccess newParameter, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__PARAMETER, oldParameter, newParameter);
  ...
  public void setParameter(StreamAccess newParameter)
  {
    if (newParameter != parameter)
    {
      ...
      if (parameter != null)
        msgs = ((InternalEObject)parameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__PARAMETER, null, msgs);
      if (newParameter != null)
        msgs = ((InternalEObject)newParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__PARAMETER, null, msgs);
      msgs = basicSetParameter(newParameter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__PARAMETER, newParameter, newParameter));
  }
  ...
  public EList<BigDecimal> getLiteralList()
  {
    if (literalList == null)
    {
      literalList = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, FlowPackage.DIVISION_OPERATOR__LITERAL_LIST);
    }
    return literalList;
  }
  ...
  public EList<StreamAccess> getStreamElementList()
  {
    ...
    {
      streamElementList = new EObjectContainmentEList<StreamAccess>(StreamAccess.class, this, FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT_LIST);
    }
  ...
  public NotificationChain basicSetStream(StreamOperatorParameter newStream, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__STREAM, oldStream, newStream);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStream(StreamOperatorParameter newStream)
  {
    if (newStream != stream)
    {
      NotificationChain msgs = null;
      if (stream != null)
        msgs = ((InternalEObject)stream).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__STREAM, null, msgs);
      if (newStream != null)
        msgs = ((InternalEObject)newStream).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlowPackage.DIVISION_OPERATOR__STREAM, null, msgs);
      msgs = basicSetStream(newStream, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.DIVISION_OPERATOR__STREAM, newStream, newStream));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case FlowPackage.DIVISION_OPERATOR__STREAM_ELEMENT_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FlowPackage.DIVISION_OPERATOR__PARAMETER:
        return getParameter();
      case FlowPackage.DIVISION_OPERATOR__LITERAL_LIST:
