 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.MultiplicationOperator#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
...
public interface MultiplicationOperator extends ReturnTypeOperator
{
  ...
  /**
   * Sets the value of the '{@link de.hs_rm.cs.vs.dsm.flow.MultiplicationOperator#getStreamElement <em>Stream Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.hs_rm.cs.vs.dsm.flow.FlowPackage#getMultiplicationOperator_Variable()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.hs_rm.cs.vs.dsm.flow.MultiplicationOperator#getVariable <em>Variable</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
