 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.AdditionOperator#getStreamElements <em>Stream Elements</em>}</li>
...
public interface AdditionOperator extends ReturnTypeOperator
{
   ...
   * @see de.hs_rm.cs.vs.dsm.flow.FlowPackage#getAdditionOperator_StreamElements()
   * @model containment="true"
   * @generated
   */
