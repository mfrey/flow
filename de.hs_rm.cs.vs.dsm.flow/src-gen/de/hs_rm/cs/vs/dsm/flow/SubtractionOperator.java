 ...
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.SubtractionOperator#getLiteralList <em>Literal List</em>}</li>
 *   <li>{@link de.hs_rm.cs.vs.dsm.flow.SubtractionOperator#getStreamElementList <em>Stream Element List</em>}</li>
...
public interface SubtractionOperator extends ReturnTypeOperator
{
   ...
   * @see de.hs_rm.cs.vs.dsm.flow.FlowPackage#getSubtractionOperator_LiteralList()
   * @model unique="false"
   * @generated
   */
   ...
   * @see de.hs_rm.cs.vs.dsm.flow.FlowPackage#getSubtractionOperator_StreamElementList()
   * @model containment="true"
   * @generated
   */
