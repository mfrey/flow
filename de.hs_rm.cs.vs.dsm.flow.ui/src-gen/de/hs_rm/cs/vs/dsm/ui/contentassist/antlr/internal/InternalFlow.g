...
:
(
{ before(grammarAccess.getDecisionTreeOperatorAccess().getRightParenthesisKeyword_12()); }

	')' 

{ after(grammarAccess.getDecisionTreeOperatorAccess().getRightParenthesisKeyword_12()); }
)
