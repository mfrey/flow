		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcessingExpressionAccess().getAlternatives(), "rule__ProcessingExpression__Alternatives");
					put(grammarAccess.getBlockExpressionAccess().getAlternatives(), "rule__BlockExpression__Alternatives");
					put(grammarAccess.getConditionalExpressionsAccess().getAlternatives(), "rule__ConditionalExpressions__Alternatives");
					...
					put(grammarAccess.getMapOperatorAccess().getGroup(), "rule__MapOperator__Group__0");
					put(grammarAccess.getMapOperatorAccess().getGroup_3(), "rule__MapOperator__Group_3__0");
					...
					put(grammarAccess.getIfElseConditionAccess().getGroup(), "rule__IfElseCondition__Group__0");
					put(grammarAccess.getIfElseConditionAccess().getGroup_7(), "rule__IfElseCondition__Group_7__0");
					put(grammarAccess.getSwitchCaseConditionAccess().getGroup(), "rule__SwitchCaseCondition__Group__0");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_4_2(), "rule__PrimaryExpression__Group_4_2__0");
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_4_2_1(), "rule__PrimaryExpression__Group_4_2_1__0");
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_4_2_1_1(), "rule__PrimaryExpression__Group_4_2_1_1__0");
					...
					put(grammarAccess.getStreamStatementAccess().getExpressionAssignment_3(), "rule__StreamStatement__ExpressionAssignment_3");
					put(grammarAccess.getVariableStatementAccess().getReferenceAssignment_0(), "rule__VariableStatement__ReferenceAssignment_0");
					put(grammarAccess.getVariableStatementAccess().getExpressionAssignment_2(), "rule__VariableStatement__ExpressionAssignment_2");
					...
					put(grammarAccess.getMapOperatorAccess().getFunctionListAssignment_2(), "rule__MapOperator__FunctionListAssignment_2");
					put(grammarAccess.getMapOperatorAccess().getFunctionListAssignment_3_1(), "rule__MapOperator__FunctionListAssignment_3_1");
					put(grammarAccess.getMapOperatorAccess().getStreamAssignment_5(), "rule__MapOperator__StreamAssignment_5");
					put(grammarAccess.getFunctionStatementAccess().getElementAssignment_0(), "rule__FunctionStatement__ElementAssignment_0");
					...
					put(grammarAccess.getReturnStatementAccess().getReturnVariableAssignment_1(), "rule__ReturnStatement__ReturnVariableAssignment_1");
					put(grammarAccess.getIfElseConditionAccess().getConditionAssignment_2(), "rule__IfElseCondition__ConditionAssignment_2");
					put(grammarAccess.getIfElseConditionAccess().getIfActionAssignment_5(), "rule__IfElseCondition__IfActionAssignment_5");
					put(grammarAccess.getIfElseConditionAccess().getElseActionAssignment_7_2(), "rule__IfElseCondition__ElseActionAssignment_7_2");
					put(grammarAccess.getSwitchCaseConditionAccess().getConditionAssignment_2(), "rule__SwitchCaseCondition__ConditionAssignment_2");
					put(grammarAccess.getSwitchCaseConditionAccess().getCaseExpressionAssignment_5(), "rule__SwitchCaseCondition__CaseExpressionAssignment_5");
					put(grammarAccess.getSwitchCaseConditionAccess().getDefaultExpressionAssignment_8(), "rule__SwitchCaseCondition__DefaultExpressionAssignment_8");
					put(grammarAccess.getCaseStatementAccess().getConditionAssignment_1(), "rule__CaseStatement__ConditionAssignment_1");
					put(grammarAccess.getCaseStatementAccess().getActionAssignment_3(), "rule__CaseStatement__ActionAssignment_3");
					put(grammarAccess.getFunctionDefinitionAccess().getTypeAssignment_0(), "rule__FunctionDefinition__TypeAssignment_0");
					...
					put(grammarAccess.getFunctionDefinitionAccess().getReturnValueAssignment_7(), "rule__FunctionDefinition__ReturnValueAssignment_7");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getFuncAssignment_4_1(), "rule__PrimaryExpression__FuncAssignment_4_1");
					put(grammarAccess.getPrimaryExpressionAccess().getArgumentsAssignment_4_2_1_0(), "rule__PrimaryExpression__ArgumentsAssignment_4_2_1_0");
					put(grammarAccess.getPrimaryExpressionAccess().getArgumentsAssignment_4_2_1_1_1(), "rule__PrimaryExpression__ArgumentsAssignment_4_2_1_1_1");
				}
			};
		}
