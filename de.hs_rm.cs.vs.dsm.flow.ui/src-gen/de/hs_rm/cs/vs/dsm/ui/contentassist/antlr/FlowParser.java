		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAdditionOperatorAccess().getGroup_4_0(), "rule__AdditionOperator__Group_4_0__0");
					put(grammarAccess.getAdditionOperatorAccess().getGroup_4_1(), "rule__AdditionOperator__Group_4_1__0");
					put(grammarAccess.getSubtractionOperatorAccess().getGroup(), "rule__SubtractionOperator__Group__0");
					put(grammarAccess.getSubtractionOperatorAccess().getGroup_4_0(), "rule__SubtractionOperator__Group_4_0__0");
					put(grammarAccess.getSubtractionOperatorAccess().getGroup_4_1(), "rule__SubtractionOperator__Group_4_1__0");
					put(grammarAccess.getMultiplicationOperatorAccess().getGroup(), "rule__MultiplicationOperator__Group__0");
					put(grammarAccess.getMultiplicationOperatorAccess().getGroup_4_0(), "rule__MultiplicationOperator__Group_4_0__0");
					put(grammarAccess.getMultiplicationOperatorAccess().getGroup_4_1(), "rule__MultiplicationOperator__Group_4_1__0");
					put(grammarAccess.getDivisionOperatorAccess().getGroup(), "rule__DivisionOperator__Group__0");
					put(grammarAccess.getDivisionOperatorAccess().getGroup_4_0(), "rule__DivisionOperator__Group_4_0__0");
					put(grammarAccess.getDivisionOperatorAccess().getGroup_4_1(), "rule__DivisionOperator__Group_4_1__0");
					...
					put(grammarAccess.getAdditionOperatorAccess().getLiteralListAssignment_4_0_0(), "rule__AdditionOperator__LiteralListAssignment_4_0_0");
					put(grammarAccess.getAdditionOperatorAccess().getStreamElementListAssignment_4_1_0(), "rule__AdditionOperator__StreamElementListAssignment_4_1_0");
					put(grammarAccess.getAdditionOperatorAccess().getStreamAssignment_5(), "rule__AdditionOperator__StreamAssignment_5");
					put(grammarAccess.getSubtractionOperatorAccess().getParameterAssignment_2(), "rule__SubtractionOperator__ParameterAssignment_2");
					put(grammarAccess.getSubtractionOperatorAccess().getLiteralListAssignment_4_0_0(), "rule__SubtractionOperator__LiteralListAssignment_4_0_0");
					put(grammarAccess.getSubtractionOperatorAccess().getStreamElementListAssignment_4_1_0(), "rule__SubtractionOperator__StreamElementListAssignment_4_1_0");
					put(grammarAccess.getSubtractionOperatorAccess().getStreamAssignment_5(), "rule__SubtractionOperator__StreamAssignment_5");
					...
					put(grammarAccess.getMultiplicationOperatorAccess().getLiteralListAssignment_4_0_0(), "rule__MultiplicationOperator__LiteralListAssignment_4_0_0");
					put(grammarAccess.getMultiplicationOperatorAccess().getStreamElementListAssignment_4_1_0(), "rule__MultiplicationOperator__StreamElementListAssignment_4_1_0");
					put(grammarAccess.getMultiplicationOperatorAccess().getStreamAssignment_5(), "rule__MultiplicationOperator__StreamAssignment_5");
					put(grammarAccess.getDivisionOperatorAccess().getParameterAssignment_2(), "rule__DivisionOperator__ParameterAssignment_2");
					put(grammarAccess.getDivisionOperatorAccess().getLiteralListAssignment_4_0_0(), "rule__DivisionOperator__LiteralListAssignment_4_0_0");
					put(grammarAccess.getDivisionOperatorAccess().getStreamElementListAssignment_4_1_0(), "rule__DivisionOperator__StreamElementListAssignment_4_1_0");
					put(grammarAccess.getDivisionOperatorAccess().getStreamAssignment_5(), "rule__DivisionOperator__StreamAssignment_5");
